...
main.Position = UDim2.new(0.499551564, 0, 0.498979568, 0)
...
UIAspectRatioConstraint_3.Parent = visuals
...
UIAspectRatioConstraint_6.Parent = profile
...
UIAspectRatioConstraint_7.Parent = gamethumb
...
UIAspectRatioConstraint_8.Parent = enable
...
UIAspectRatioConstraint_9.Parent = enable_2
...
UIAspectRatioConstraint_10.Parent = enable_3
...
searchbox.Position = UDim2.new(0.0172413792, 0, 0.0321543403, 0)
...
UIAspectRatioConstraint_11.Parent = search
...
UIAspectRatioConstraint_12.Parent = close
...
UIStroke_26.Parent = open

UICorner_35.CornerRadius = UDim.new(0, 100)
UICorner_35.Parent = open

UIAspectRatioConstraint_13.Parent = open

-- Scripts:

local function QIWXMR_fake_script() -- main.LocalScript 
	...
	click(searchbutton, function()
		if issearching then
			game.StarterGui:SetCore("SendNotification", {
				Title = "Alysse",
				Text = "A search is currently in progress. Please wait for the Search Icon to return back to normal which indicates that a search has been finished.",
				Duration = 1,
			})
			return
		end
		...
		wait(0.2)
		searchbutton.Image = "rbxassetid://11432841158"
		wait(0.2)
